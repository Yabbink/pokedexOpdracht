$(document).ready(function(){
    ...
    function getPokemonPagina(nummer){
    ...
    function getPokemonPaginaShiny(nummer){
      let offset = (nummer - 1) * aantalPokemons;
      console.log(offset)
      let pokeURL = "https://pokeapi.co/api/v2/pokemon?offset=" + offset + "&limit=" + aantalPokemons;
    ...
    function pokemonDetails(id)
    {
      ...
      $.ajax({
        ...
        success: function(details){
          console.log(details)
          let pokeImage = details.sprites.front_default
    ...
    function pokemonDetailsShiny(id)
    {
      let pokeURL = "https://pokeapi.co/api/v2/pokemon/" + id;
      $.ajax({
        url: pokeURL,
        ...
        success: function(details){
          console.log(details)
          let pokeImage = details.sprites.front_shiny
